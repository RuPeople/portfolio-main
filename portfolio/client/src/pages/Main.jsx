    ...
    return (
        <AnimatePresence>
            <motion.section
                ...
                <motion.div className="main__socials d-flex flex-column justify-content-start align-items-start my-5"
                     initial={{ opacity: 0 }}
                     whileInView={{ opacity: 1 }}
                     viewport={{ once: true }}>
                    ...
                    <address className="w-100 d-flex flex-column justify-content-start align-items-start">
                        ...
                        }} className="main__socials_link d-flex flex-row justify-content-start align-items-center py-1 px-3 w-auto my-1" href="https://github.com/RuPeople">
                        ...
                        <motion.a whileHover={{
                            rotate: Math.random() * 20 - 10,
                        }} className="main__socials_link d-flex flex-row justify-content-start align-items-center py-1 px-3 w-auto my-1" href="https://discord.com/users/Cerberus#3933/">
                            <svg className="me-2" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
